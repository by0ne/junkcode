...
#ident "$Id: pwio.c,v 1.4 2010/03/21 14:56:59 jbj Exp $"
...
{
	return (const struct passwd *) commonio_locate (&passwd_db, name);
}
...
{
	return (const struct passwd *) commonio_next (&passwd_db);
}
