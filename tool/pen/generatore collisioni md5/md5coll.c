 ...
 *
 *  14-Nov-2005: modified by Steve Dispensa <dispensa@positivenetworks.net> 
...
long winRandom(void)
{
	...
	{
		char buf[100];
		StringCbPrintf(buf, sizeof(buf), "error generating random number: 0x%x", GetLastError());
		MessageBox(0, buf, "error", MB_ICONERROR|MB_OK);
		return 0;
	}
